...
{
	use Crud, CountryTrait, Notifiable, HasFactory, LatestOrPremium, SimilarByCategory, SimilarByLocation,CustomFieldTrait;
	...
	protected $appends = ['created_at_formatted', 'user_photo_url'];
