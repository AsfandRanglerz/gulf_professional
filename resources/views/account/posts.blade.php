				...
				<div class="col-md-9 page-content">
					<div class="inner-box">
						@if ($pagePath=='my-posts')
							<h2 class="title-2"><i class="icon-docs"></i> {{ 'My Profile' }} </h2>
						@elseif ($pagePath=='archived')
							<h2 class="title-2"><i class="icon-folder-close"></i> {{ 'Archived Profile' }} </h2>
						@elseif ($pagePath=='favourite')
							<h2 class="title-2"><i class="icon-book-open"></i> My Contact Directory </h2>
						@elseif ($pagePath=='pending-approval')
							<h2 class="title-2"><i class="icon-hourglass"></i> {{ 'Pending Profile' }} </h2>
						@else
							<h2 class="title-2"><i class="icon-docs"></i> {{ 'My Profile' }} </h2>
						@endif
						...
						<div class="table-responsive">
							<form name="listForm" method="POST" action="{{ url('account/' . $pagePath . '/delete') }}">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										...
										<td style="width:58%" class="items-details-td">
											<div>
												...
												<p>
													<strong>Views</strong> {{ $post->visits ?? 0 }}
									...
									@if ($pagePath=='my-posts')
									<tr>
										<td colspan="4" class="text-center">Your profile has been submitted to Gulf Lab EXPO and is currently being reviewed for publication standards. You will be able to see your profile here once it is activated.</td>
									</tr>
									@endif
									@endif
									</tbody>
