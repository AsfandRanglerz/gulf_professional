...
<div class="main-wrapper">
    ...
    try {
        if (is_link(public_path('storage'))) {
            ...
            $wrapperStyle = 'background:url(' . 'http://gulflabexpo.com/bd/public/images/admin-back.jpg' . ') no-repeat center center; background-size: cover;';
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="{!! $wrapperStyle !!}">
        <div class="auth-box p-4 bg-white rounded">
            ...
            <div class="logo text-center mb-5">
                <a href="{{ url('/') }}">
                    <img src="{{ $logoUrl }}" alt="logo" class="img-fluid" style="width:150px; height:auto;">
                </a>
                <hr>
            </div>
