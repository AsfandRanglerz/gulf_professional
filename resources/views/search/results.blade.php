			...
			<div class="row">
				...
				<div class="{{ $contentColSm }} page-content col-thin-left">
							...
							<ul id="postType" class="nav nav-tabs add-tabs tablist" role="tablist">
								...
								<li {!! $liClass !!}>
									<a href="{!! qsUrl(request()->url(), request()->except(['page', 'type']), null, false) !!}"
									   ...
									   class="nav-link"
									>
										{{ 'All Profiles' }} <span class="badge badge-pill {!! $spanClass !!}">{{ $count->get('all') }}</span>
									</a>
								</li>
								@if (config('settings.single.show_post_types'))
					...
					<div class="post-promo text-center mb-5">
						<h2> {{ 'Would you like to network in the MENA clinical lab industry' }} </h2>
						<h5>Create your profile FOR FREE and get listed on the industry’s leading platform!</h5>
						<h5>Connect with buyers, sellers and other lab industry experts</h5>
