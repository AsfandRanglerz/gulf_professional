				...
				<div class="col-md-4 reg-sidebar">
					<div class="reg-sidebar-inner text-center">
						<div class="promo-text-box"><i class="icon-picture fa fa-4x icon-color-1"></i>
							<h3><strong>Post Your Profile for Free</strong></h3>
							<p class="text-left">
								<!-- {{ t('do_you_have_something_text',
								['appName' => config('app.name')]) }} -->
								Post your profile on Gulf Lab EXPO and declare your presence in the MENA Lab industry. Contact or Get Contacted for career, business and networking opportunities
							</p>
						</div>
						<div class="promo-text-box"><i class=" icon-pencil-circled fa fa-4x icon-color-2"></i>
							<h3><strong>Opt for a Premium Profile</strong></h3>
							<p class="text-left">Opt for a Premium profile when submitting your profile and get your profile featured on the home page for maximum visibility. 
							<br><br>	
							Increase networking capability and contact 3 x more professionals. 
							</p>
						</div>
						<div class="promo-text-box"><i class="icon-heart-2 fa fa-4x icon-color-3"></i>
							<h3><strong>Save Profiles of Interest</strong></h3>
							<p class="text-left">Create your own list of contact profiles.  You can then access your contact list at any time later</p>
						</div>
					</div>
				</div>
			</div>
