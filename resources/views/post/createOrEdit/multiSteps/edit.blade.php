			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box category-content">
						<h2 class="title-2">
							<strong> <i class="icon-docs"></i> Update My Profile</strong>
									...
									<fieldset>
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<input id="title" name="designation" placeholder="Designation" class="form-control input-md{{ $designationError }}"
													   type="text" value="{{ old('designation', $post->designation) }}">
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<input id="title" name="employer" placeholder="Employer" class="form-control input-md{{ $employerError }}"
													   type="text" value="{{ old('employer', $post->employer) }}">
										...
										<div class="form-group row pt-3">
											<div class="col-md-12 text-center">
												...
												{{-- <button id="nextStepBtn" class="btn btn-primary btn-lg"> Save </button> --}}
												<button id="" class="btn btn-primary btn-lg"> Save </button>
											</div>
											<div class="col-md-12 text-center mt-3">
												Note: You will be able to modify your photograph in the next step
											</div>
										</div>
