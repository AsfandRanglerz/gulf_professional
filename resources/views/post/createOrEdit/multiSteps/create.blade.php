							...
							<div class="col-xl-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ request()->fullUrl() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										@if (config('settings.single.show_post_types'))
											...
											@if (isset($postTypes))
												...
												<div id="postTypeBloc" class="form-group row required">
													<label class="col-md-3 col-form-label">Profession Category <sup>*</sup></label>
													<div class="col-md-8">
														...
														<div class="form-check form-check-inline pt-2">
															<input name="post_type_id"
																...
																{{ (old('post_type_id')==$postType->tid) ? ' checked="checked"' : '' }}
															>
										...
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="title">Full Name<sup>*</sup></label>
											<div class="col-md-8">
												<input id="title" name="title" placeholder="Enter your name" class="form-control input-md{{ $titleError }}"
													   type="text" value="{{ old('title') }}">
												<small id="" class="form-text text-muted">Please provide your full name here</small>
											</div>
										</div>


										<!-- designation -->
										<?php $designationError = (isset($errors) and $errors->has('designation')) ? ' is-invalid' : ''; ?>
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="title">Designation<sup>*</sup></label>
											<div class="col-md-8">
												<input id="title" name="designation" placeholder="Designation" class="form-control input-md{{ $designationError }}"
													   type="text" value="{{ old('designation') }}">
												<small id="" class="form-text text-muted">Please provide your designation</small>
											</div>
										</div>

										<!-- Employer -->
										<?php $employerError = (isset($errors) and $errors->has('employer')) ? ' is-invalid' : ''; ?>
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="title">Employer<sup>*</sup></label>
											<div class="col-md-8">
												<input id="title" name="employer" placeholder="Employer" class="form-control input-md{{ $employerError }}"
													   type="text" value="{{ old('employer') }}">
										...
										*/
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">												<div class="input-group show-pwd-group">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="icon-key"></i></span>
													</div>
											...
											@if (in_array(config('settings.single.auto_registration'), [1, 2]))
												...
												@if (config('settings.single.auto_registration') == 1)
													...
													<div class="form-group row required d-none">
														...
														<div class="col-md-8">
															<div class="form-check">
																<input name="auto_registration" id="auto_registration" checked
