				...
				<div class="col-lg-9 page-content col-thin-right">
					<div class="inner inner-box items-details-wrapper pb-0">
						...
						<span class="info-row">
							...
							<span class="px-2 detail-line-value" style="float: unset;font-size: 16px;color: #4682b4;">

								<i class="fas fa-briefcase"></i>

								{{ ($post->designation !=null) ? $post->designation : 'Not Entered'}}
							</span>
							<span class="px-2 detail-line-value" style="float: unset;font-size: 16px;color: #4682b4;">

								<i class="fas fa-building"></i>

								{{ $post->employer != null? $post->employer : 'Not Entered'}}
							</span>
						</span>
							...
							@if (count($post->pictures) > 0)
								...
								{{-- <div class="product-view-thumb-wrapper">
									...
									{{-- <div class=" col-md-6 mx-auto">
										<img src="{{ imgUrl($post->pictures[0]->filename, 'small') }}" alt="{{ $titleSlug . '-small-' . $key }}">
									</div> --}}
										...
										<div class="items-details-info col-md-12 col-sm-12 col-xs-12 enable-long-words from-wysiwyg">
											...
											<div class="row">
												<div class="col-12 detail-line-content">
													{!!$post->description? transformDescription($post->description): 'Profile summary not provided by member' !!}
												</div>
											</div>
...
{{--													@endif--}}
				...
				<div class="col-lg-3 page-sidebar-right">
					<aside>
									...
									@if (auth()->check())
										@if (auth()->user()->id == $post->user_id)
											...
											@if (config('settings.single.publication_form_type') == '1')
												...
												@endif --}}
											@endif
											{!! genDiscussionBtn($post, true) !!}

										@elseif(auth()->check())
											{{-- {!! genPhoneNumberBtn($post, true) !!} --}}
											{{--{!! genEmailContactBtn($post, true) !!}--}}

											{!! genEmailContactBtn($post, true,false) !!}
										@endif
										<?php
										try {
						...
						<div class="card sidebar-card">
							<div class="card-header">{{ 'Networking tips for members ' }}</div>
							<div class="card-content">
								<div class="card-body text-left">
									<ul class="list-check">
										<li> {{ 'Stay active on the forum' }} </li>
										<li> {{ 'Join ongoing discussions' }} </li>
										<li> {{ 'Contribute useful information' }} </li>
									</ul>
...
@section('after_scripts')
	...
	<script>
        ...
        var lang = {
            labelSavePostSave: "{!! 'Add to my Contact Directory' !!}",
            labelSavePostRemove: "{!! 'Remove from My Contact Directory' !!}",
            loginToSavePost: "{!! t('Please log in to save the profiles') !!}",
            loginToSaveSearch: "{!! t('Please log in to save your search') !!}",
            confirmationSavePost: "{!! 'Profile added to your Contact Directory' !!}",
            confirmationRemoveSavePost: "{!! 'Profile has been removed from your Contact Directory' !!}",
