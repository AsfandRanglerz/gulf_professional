...
return [
	...
	*/
	...
	// post_activated (new)
	'post_activated_title'             => 'Your profile has been created',
	'post_activated_content_1'         => 'Hello :title,',
	'post_activated_content_2'         => 'Thank you for creating your profile on Gulf Lab EXPO.',
	'post_activated_content_3'         => 'The profile will now be reviewed for publication standards. You will be notified via email as soon as the profile is activated.',
	'post_activated_content_4'         => 'If you do not receive a profile activation email within two business days, please get in touch with us on info@gulflabexpo.com <br><br>
	Please remember to check your Spam folder.',

	// post_updated (new)
	'post_updated_title'             => 'Your profile has been updated',
	'post_updated_content_1'         => 'Hello :title,',
	'post_updated_content_2'         => 'We are pleased to inform you that your profile on Gulf Lab EXPO has been updated',
	'post_updated_content_3'         => 'You can view your profile by following this link, <a href=":postUrl">:title</a>',
	'post_updated_content_4'         => 'Remember to take full advantage of regional networking opportunities by posting and joining discussions on the Community Forum on a regular basis.',
	
	
	// post_reviewed (new)
	'post_reviewed_title'              => 'Your profile is now activated',
	'post_reviewed_content_1'          => 'Hello :title,',
	'post_reviewed_content_2'          => 'We are pleased to inform you that your profile on Gulf Lab EXPO has been activated. <br><br> You can view your profile by following this link,  <a href=":postUrl">:title</a>',
	'post_reviewed_content_3'          => 'You will now be able to send messages to other community members through the message board. Your profile also gives you access to the “Ask/Advise” discussion forum on Gulf Lab EXPO, where you can network with other lab professionals in the MENA region. <br><br> Remember to take full advantage of regional networking opportunities by posting and joining discussions on the Community Forum on a regular basis.',
	
	
	// post_republished (new)
	'post_republished_title'              => 'Your profile has been re-published',
	'post_republished_content_1'          => 'Hello,',
	'post_republished_content_2'          => 'Your profile <a href=":postUrl">:title</a> has been re-published successfully.',
	'post_republished_content_3'          => 'You\'re receiving this email because you recently created a new profile on :appName. If this wasn\'t you, please ignore this email.',
	
	
	// post_deleted
	'post_deleted_title'               => 'Your profile has been deleted',
	'post_deleted_content_1'           => 'Hello,',
	'post_deleted_content_2'           => 'Your profile ":title" has been deleted from <a href=":appUrl">:appName</a> at :now.',
	...
	'post_seller_contacted_title'      => 'Your profile ":title" on :appName',
	'post_seller_contacted_content_1'  => '<strong>Contact Information:</strong>
<br>Name: :name
<br>Email address: :email
<br>Phone number: :phone',
	'post_seller_contacted_content_2'  => 'This email was sent to you about the profile ":title" you filed on :appName : <a href=":postUrl">:postUrl</a>',
...
<br><br>If you have any doubt about the seriousness of an advertiser, please contact us immediately. We can then neutralize as quickly as possible and prevent someone less informed do become the victim.',
	...
	// post_archived
	'post_archived_title'              => 'Your profile has been archived',
	'post_archived_content_1'          => 'Hello,',
	'post_archived_content_2'          => 'Your profile ":title" has been archived from :appName at :now.',
	'post_archived_content_3'          => 'You can repost it by clicking here : <a href=":repostUrl">:repostUrl</a>',
	'post_archived_content_4'          => 'If you do nothing your profile will be permanently deleted on :dateDel.',
	...
	'post_will_be_deleted_title'       => 'Your profile will be deleted in :days days',
	'post_will_be_deleted_content_1'   => 'Hello,',
	'post_will_be_deleted_content_2'   => 'Your profile ":title" will be deleted in :days days from :appName.',
	'post_will_be_deleted_content_3'   => 'You can repost it by clicking here : <a href=":repostUrl">:repostUrl</a>',
	'post_will_be_deleted_content_4'   => 'If you do nothing your profile will be permanently deleted on :dateDel.',
	...
	// post_notification
	'post_notification_title'          => 'New profile has been posted',
	'post_notification_content_1'      => 'Hello Admin,',
	'post_notification_content_2'      => 'The user :advertiserName has just posted a new ad.',
	'post_notification_content_3'      => 'The profile title: <a href=":postUrl">:title</a><br>Posted on: :now at :time',
	...
	'payment_sent_content_2'         => 'We have received your payment for the profile "<a href=":postUrl">:title</a>".',
	...
	'payment_notification_content_2' => 'The user :advertiserName has just paid a package for her profile "<a href=":postUrl">:title</a>".',
	'payment_notification_content_3' => 'THE PAYMENT DETAILS
<br><strong>Reason of the payment:</strong> profile #:adId - :packageName
...
<br><strong>Payment Method:</strong> :paymentMethodName',
	...
	'payment_approved_content_2' => 'Your payment for the profile "<a href=":postUrl">:title</a>" has been approved.',
