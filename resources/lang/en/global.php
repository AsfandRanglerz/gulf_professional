...
return [
    ...
    */
    ...
    'free_local_classified_ads_in_the_world' => 'Free Local Classified profiles in the World',
    'free_local_classified_ads_in_location' => 'Free Local Classified profiles in :location',
    ...
    'post_your_free_ads_here' => 'Post your Free profiles here',
    'make_your_deal_now' => 'Make your deal Now!',
    'free_ads' => 'Free profiles',
    'free_ads_in' => 'Free profiles in',
    'free_ads_in_location' => 'Free profiles in :location',
    'free_ads_in_category' => 'Free profiles in :category',
    'free_ads_category_in_location' => 'Free profiles :category in :location',
    'search_for' => 'Search for',
    'latest_free_ads' => 'Latest free profiles',
    'count_free_local_classified_ads' => 'count_free_local_classified_profiles',
    'count_free_local_classified_ads_in_location' => ':count free local classified profiles in <strong>:location</strong>',
    '100_percent_free_local_classified_ads' => '100% Free local classified profiles',
    'free_ads_in_the_world' => 'Free profiles in the World',
    ...
    'post_free_ads' => 'Post Free profiles',
    'start_now' => 'Start Now!',
    ...
    'locations' => 'Locations',
    'urgent' => 'Urgent',
    'urgent_ads_only' => 'Urgent profiles only',
    ...
    'become_a_best_seller_or_buyer_text' => 'Become a best seller or buyer. Create and Manage your profiles. Repost your old profiles, etc.',
    'create_your_favorite_ads_list' => 'Create your Favorite profiles list.',
    'create_your_favorite_ads_list_text' => 'Create your Favorite  profiles list. And save your search. Don\'t forget any deal.',
    ...
    'describe_what_makes_your_ad_unique' => 'Describe what makes your profile unique',
    'price' => 'Price',
    'ei_price' => 'eg 15000',
    ...
    'my_ads' => 'My profiles',
    'my_ads_on' => 'My profiles on :appName',
    ...
    'my_archived_ads' => 'My archived profiles',
    'my_archived_ads_on' => 'My archived profiles on :appName',
    'my_favourite_ads' => 'My favourite profiles',
    'my_favourite_ads_on' => 'My favourite profiles on :appName',
    'my_pending_approval_ads' => 'My pending approval profiles',
    'my_pending_approval_ads_on' => 'My pending approval profiles on :appName',
    ...
    'posting_ads_is_disabled' => 'Posting profiles is disabled for this time. Please try later. Thank you.',
    'your_ad_has_been_created' => 'Your profile has been created. Please check your email for details',
    
    'update_my_ad' => 'Update My Ad',
    'your_ad_has_been_updated' => 'Your profile has been updated.',
    ...
    'welcome_to_app_100_free' => 'Welcome to :appName : 100% Free profiles Classified. Sell and buy near you. Simple, fast and efficient.',
    'sitemap_domain_country_100_free' => 'Sitemap :domain - :country. 100% Free profiles Classified',
	
    'archived_ads' => 'Archived profiles',
    'favourite_ads' => 'Favourite profiles',
    'pending_approval' => 'Pending approval',
    'Select' => 'Select',
    'All' => 'All',
    'Delete' => 'Delete',
    'clear' => 'clear',
    'Ads Details' => 'profiles Details',
    'Posted On' => 'Posted On',
    'Visitors' => 'Visitors',
    ...
    'count_posts' => '{0} ad|{1} ad|[2,*] profiles',
    ...
    'Hide the phone number on the published ads' => 'Hide the phone number on the published profiles.',
    'About Yourself' => 'About Yourself',
    'Update' => 'Update',
    'Settings' => 'Settings',
    'Comments are enabled on my ads' => 'Comments are enabled on my profiles',
    'Disable comments on my ads' => 'Disable comments on my profiles',
    ...
    'Business Ads' => 'Business profiles',
    'Private Ads' => 'Private profiles',
    'B' => 'B',
    'P' => 'P',
    ...
    'this_ad_is_expired' => '<strong>Warning !</strong> This profile has expired. The product or service is not more available (may be)',
    'back_to_results' => 'Back to Results',
    '_type_ad' => ':type ad',
    'ad_details' => 'Profile Details',
    'post_details' => 'Post\'s Details',
    'Salary' => 'Salary',
    'Item' => 'Item',
    'More ads by User' => 'More profiles by User',
    ...
    'Please log in to save the Ads' => 'Please log in to save the profiles.',
    ...
    'premium_plans_hint' => 'The premium package help sellers to promote their products or services by giving more visibility to their profiles to attract more buyers and sell faster.',
    'Regular List' => 'Free',
    ...
    'your_account_has_been_deleted_1' => 'Your account has been deleted.',
    'your_account_has_been_deleted_2' => 'Your account has been deleted.',
	...
	'Home - Featured Ads' => 'Featured <span style="font-weight: bold;">profiles</span>',
	'Similar Ads' => 'Similar <span style="font-weight: bold;">profiles</span>',
	'more_ads_at_x_distance_around_city' => 'More profiles at :distance :unit around <span style="font-weight: bold;">:city</span>',
    ...
    'Home - Latest Ads' => 'Latest <span style="font-weight: bold;">profiles</span>',
    'Home - Sponsored Ads' => 'Premium <span style="font-weight: bold;">profiles</span>',
    'Photos' => 'Photograph',
    'Images' => 'Images',
    'Preview' => 'Preview',
    'Done' => 'Done',
	...
	'Hide the phone number on the ads' => 'Hide the phone number on the profiles.',
	'Hide' => 'Hide',
	'Show' => 'Show',
	...
	'Manage Ad' => 'Manage Ad',
	'After the promotion expires, your ad will be offline after X days' => 'After the promotion expires, your profile will be offline after :activatedPostsExpiration days.',
	'count_days' => '{0} day|{1} day|[2,*] days',
	'count_promotion_days' => '{0} promotion day|{1} promotion day|[2,*] promotion days',
	'Mobile Phone Number' => 'Mobile Phone Number',
	'The requested ad type does not exist' => 'The requested profile type does not exist.',
	'This user has been banned' => 'This user has been banned.',
	'The ad is already online' => 'The profile is already online.',
	'Menu' => 'Menu',
	...
	'Offline' => 'Offline',
	'offline_putting_message' => 'The profile (ID: :postId) has been put offline successfully. You can re-publish it by browsing the list of archived profiles. If you do nothing, the profile will be permanently deleted on :dateDel.',
	'The putting offline has failed' => 'The putting offline has failed. Please try again.',
	'The ad is already offline' => 'The profile is already offline.',
...
<li><strong>Important:</strong> Don\'t send money remotely for a product or for a service.</li>',
	...
	'whatsapp_pre_filled_message' => 'I\'m interested in your profile ":title" posted on :appName',
	'go_to_parent_categories' => 'Go to parent categories',
	'Root' => 'Root',
	'category_not_found' => 'Category not found.',
	'city_not_found' => 'City not found',
	'admin_division_not_found' => 'Administrative division not found',
	'post_type_hint' => 'This will be displayed on the profile details page to inform other users.',
	...
	'facebook_ads_included' => '{0}Facebook profiles (:number day)|{1}Facebook profiles (:number day)|[2,*]Facebook profiles (:number days)',
	'google_ads_included' => '{0}Google profiles (:number day)|{1}Google profiles (:number day)|[2,*]Google profiles (:number days)',
	'twitter_ads_included' => '{0}Twitter profiles (:number day)|{1}Twitter profiles (:number day)|[2,*]Twitter profiles (:number days)',
	'linkedin_ads_included' => '{0}LinkedIn profiles (:number day)|{1}LinkedIn profiles (:number day)|[2,*]LinkedIn profiles (:number days)',
