...
{
    exec('composer require urb/xenforobridge:dev-master');
...
Route::group([
	...
	Route::get('lang-register/{code}', 'Locale\SetLocaleController@redirect_to_register');
...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
		...
		Route::get('create-1', 'HomeController@select_country');
