	...
	$.ajax({
		...
		if (data.status == 1) {
			if ($(elmt).hasClass('btn')) {
				...
				$(elmt).html('<i class="fa fa-folder tooltipHere" data-toggle="tooltip" data-original-title="' + lang.labelSavePostRemove + '"></i>');
			}
			alert('s');
			...
			if ($(elmt).hasClass('btn')) {
				...
				$(elmt).html('<i class="far fa-folder tooltipHere" data-toggle="tooltip" data-original-title="' + lang.labelSavePostSave + '"></i>');
			}
			alert('b');
